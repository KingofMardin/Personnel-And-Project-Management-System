                                ...
                                <table width="100%" class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="personelduzenleY.jsp?id=<%=rs.getString("kayitNo")%>" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></a>
                                                <a href="personelsilY.jsp?id=<%=rs.getString("kayitNo")%>" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></a>
                                            </td>
