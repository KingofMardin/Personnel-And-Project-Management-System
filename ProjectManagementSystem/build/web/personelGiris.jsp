        ...
        <div class="row page-card">
            <div class="col-lg-8 offset-1">                    
                <ul class="nav nav-pills nav-fill">                  
                    <li class="nav-item">
                        <a class="nav-link unactive" href="yoneticiGiris.jsp">Yönetici</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-lg-8 offset-1 jumbotron">                   
                ...
                <form action="personelLog.jsp">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="kullaniciAdip" placeholder="Kullanıcı adınızı giriniz" />
                    </div>

                    <div class="form-group">
                        <label for="inputPass">Şifre</label>
                        <input class="form-control" type="password" name="sifrep" placeholder="Şifrenizi giriniz" />
                    </div>                    

                    <button type="submit" class="btn btn-primary btn-hover">Giriş Yap</button>
                    <br><br>
                    <a class="bottom-title">Buralarda yeni misiniz? <a href="personelKaydol.jsp"> Kaydol!</a></a>
                </form>                    
            </div>
        </div>        
    </div>
